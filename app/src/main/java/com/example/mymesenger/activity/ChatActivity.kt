package com.example.mymesenger.activity
...
import com.example.mymesenger.adapter.MesageAdapter
import com.example.mymesenger.databinding.ActivityChatBinding
        ...
        database.reference.child("chats").child(senderRoom).child("message")
            .addValueEventListener(object :ValueEventListener{
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    binding.recyclerView.adapter = MesageAdapter(this@ChatActivity, list)
                }
